...
namespace Plumsys.Web.UI.Page
{
    public partial class usercenter : Web.UI.UserPage
    {
        ...
        protected override void InitPage()
        {
            ...
            {
                //清险Session
                HttpContext.Current.Session[PLKeys.SESSION_USER_INFO] = null;
                //清除Cookies
                Utils.WriteCookie(PLKeys.COOKIE_USER_NAME_REMEMBER, "Plumsys", -43200);
                Utils.WriteCookie(PLKeys.COOKIE_USER_PWD_REMEMBER, "Plumsys", -43200);
                Utils.WriteCookie("UserName", "Plumsys", -1);
                Utils.WriteCookie("Password", "Plumsys", -1);
                //自动登录,跳转URL
