<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="area_edit.aspx.cs" Inherits="Plumsys.Web.admin.settings.area_edit" ValidateRequest="false" %>
...
<!--导航栏-->
<div class="location">
  <a href="area_list.aspx" class="back"><i></i><span>返回列表页</span></a>
  <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="area_list.aspx"><span>地区类别</span></a>
  <i class="arrow"></i>
  <span>编辑分类</span>
</div>
