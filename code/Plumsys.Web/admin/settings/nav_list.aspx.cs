...
namespace Plumsys.Web.admin.settings
{
    public partial class nav_list : Web.UI.ManagePage
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(PLEnums.ActionEnum.Edit.ToString(), "保存导航排序"); //记录日志
        ...
        {
            ChkAdminLevel("sys_navigation", PLEnums.ActionEnum.Delete.ToString()); //检查权限
            BLL.navigation bll = new BLL.navigation();
            for (int i = 0; i < rptList.Items.Count; i++)
            {
                int id = Convert.ToInt32(((HiddenField)rptList.Items[i].FindControl("hidId")).Value);
            ...
            AddAdminLog(PLEnums.ActionEnum.Delete.ToString(), "删除导航菜单"); //记录日志
