<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="builder_html.aspx.cs" Inherits="Plumsys.Web.admin.settings.builder_html" %>
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data == 0) {
                    ...
                    dialogDG.find('.title h2').html('执行请求完毕');
                    dialogDG.find('.content').html('<font color=red>您还未开启生成静态功能！<a navid=\"site_config\" href=\"sys_config.aspx\" target=\"mainframe\">立即开启</a></font>');
                    isLock = false; //解除锁定
                }
                else {
                    var json = eval(data);
