...
namespace Plumsys.Web.admin.settings
{
    public partial class templet_file_edit : Web.UI.ManagePage
    {
        ...
        {
            pathName = PLRequest.GetQueryString("path");
            fileName = PLRequest.GetQueryString("filename");
        ...
        {
            ChkAdminLevel("sys_site_templet", PLEnums.ActionEnum.Edit.ToString()); //检查权限
            ...
            AddAdminLog(PLEnums.ActionEnum.Edit.ToString(), "修改模板文件:" + this.fileName);//记录日志
