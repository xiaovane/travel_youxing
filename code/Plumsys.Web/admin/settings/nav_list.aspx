<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nav_list.aspx.cs" Inherits="Plumsys.Web.admin.settings.nav_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="nav_edit.aspx?action=<%=PLEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
  ...
  <ItemTemplate>
    <tr>
      ...
      <td style="white-space:nowrap;word-break:break-all;overflow:hidden;">
        ...
        <a href="nav_edit.aspx?action=<%#PLEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a>
      ...
      <td align="center" style="white-space:nowrap;word-break:break-all;overflow:hidden;">
        <a href="nav_edit.aspx?action=<%#PLEnums.ActionEnum.Add %>&id=<%#Eval("id")%>">添加子级</a>
        <a href="nav_edit.aspx?action=<%#PLEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
      </td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
