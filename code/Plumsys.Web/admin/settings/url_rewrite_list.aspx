<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="url_rewrite_list.aspx.cs" Inherits="Plumsys.Web.admin.settings.url_rewrite_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="url_rewrite_edit.aspx?action=<%=PLEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td align="center"><a href="url_rewrite_edit.aspx?action=<%#PLEnums.ActionEnum.Edit %>&name=<%#Eval("name")%>">修改</a></td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
