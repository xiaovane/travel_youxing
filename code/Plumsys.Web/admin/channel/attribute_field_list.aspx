<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="attribute_field_list.aspx.cs" Inherits="Plumsys.Web.admin.channel.attribute_field_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="attribute_field_edit.aspx?action=<%=PLEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td align="center"><a href="attribute_field_edit.aspx?action=<%#PLEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
