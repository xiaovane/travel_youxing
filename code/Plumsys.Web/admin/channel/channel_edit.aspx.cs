...
namespace Plumsys.Web.admin.channel
{
    public partial class channel_edit : Web.UI.ManagePage
    {
        ...
        private string GetInherit(string page_type)
        {
            ...
            {
                case "index":
                    result = "Plumsys.Web.UI.Page.article";
                    break;
                case "category":
                    result = "Plumsys.Web.UI.Page.category";
                    break;
                case "list":
                    result = "Plumsys.Web.UI.Page.article_list";
                    break;
                case "detail":
                    result = "Plumsys.Web.UI.Page.article_show";
                    break;
            }
            return result;
        }
        ...
        private bool DoAdd()
        {
            ...
            AddAdminLog(PLEnums.ActionEnum.Add.ToString(), "添加频道" + model.title); //记录日志
            return true;
        }
        #endregion
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                ChkAdminLevel("sys_channel_manage", PLEnums.ActionEnum.Add.ToString()); //检查权限
                if (!DoAdd())
                {
                    JscriptMsg("保存过程中发生错误！", "");
                    return;
