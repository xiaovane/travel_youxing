<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="channel_list.aspx.cs" Inherits="Plumsys.Web.admin.channel.channel_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="channel_edit.aspx?action=<%=PLEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td><%#Eval("name")%></td>
      <td><%#Eval("title")%></td>
      <td><%#new Plumsys.BLL.channel_site().GetTitle(Convert.ToInt32(Eval("site_id")))%></td>
      ...
      <td align="center"><a href="channel_edit.aspx?action=<%#PLEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
