...
namespace Plumsys.Web.admin.manager
{
    public partial class role_list : Web.UI.ManagePage
    {
        ...
        {
            ChkAdminLevel("manager_role", PLEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0; //成功数量
            ...
            AddAdminLog(PLEnums.ActionEnum.Delete.ToString(), "删除管理角色" + sucCount + "条，失败" + errorCount + "条"); //记录日志
