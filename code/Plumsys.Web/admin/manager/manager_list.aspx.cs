...
namespace Plumsys.Web.admin.manager
{
    public partial class manager_list : Web.UI.ManagePage
    {
        ...
        {
            ChkAdminLevel("manager_list", PLEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.manager bll = new BLL.manager();
            ...
            AddAdminLog(PLEnums.ActionEnum.Delete.ToString(), "删除管理员" + sucCount + "条，失败" + errorCount + "条"); //记录日志
