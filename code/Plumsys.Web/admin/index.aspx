<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Plumsys.Web.admin.index" %>
    ...
    <div class="nav-right">
      <div class="info">
        ...
        <span>
          ...
          <%=new Plumsys.BLL.manager_role().GetTitle(admin_info.role_id) %>
        </span>
      </div>
      <div class="option">
        <i></i>
