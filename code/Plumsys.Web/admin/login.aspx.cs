...
namespace Plumsys.Web.admin
{
    public partial class login : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                new BLL.manager_log().Add(model.id, model.user_name, PLEnums.ActionEnum.Login.ToString(), "用户登录");
            }
            //写入Cookies
            Utils.WriteCookie("DTRememberName", model.user_name, 14400);
            Utils.WriteCookie("AdminName", "Plumsys", model.user_name);
            Utils.WriteCookie("AdminPwd", "Plumsys", model.password);
