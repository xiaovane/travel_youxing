...
namespace Plumsys.Web.admin.article
{
    public partial class comment_edit : Web.UI.ManagePage
    {
        ...
        {
            ChkAdminLevel("channel_" + this.channel_name + "_comment", PLEnums.ActionEnum.Reply.ToString()); //检查权限
            ...
            bll.Update(model);
            AddAdminLog(PLEnums.ActionEnum.Reply.ToString(), "回复" + this.channel_name + "频道评论ID:" + model.id); //记录日志
