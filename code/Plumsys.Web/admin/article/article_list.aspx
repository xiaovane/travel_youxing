<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_list.aspx.cs" Inherits="Plumsys.Web.admin.article.article_list" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="article_edit.aspx?action=<%=PLEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"><i></i><span>新增</span></a></li>
                            <li>
                        ...
                        <div class="menu-list">
                            ...
                            <div class="rule-single-select">
                                <asp:DropDownList ID="ddlMoveAreaId" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlMoveAreaId_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                            <div class="rule-single-select">
                                <asp:DropDownList ID="ddlAreaId" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlAreaId_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                            <div class="rule-single-select">
            ...
            <asp:Repeater ID="rptList1" runat="server" OnItemCommand="rptList_ItemCommand">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td><a href="article_edit.aspx?action=<%#PLEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
                        <td><%#new Plumsys.BLL.article_category().GetTitle(Convert.ToInt32(Eval("category_id")))%></td>
                        ...
                        <td align="center">
                            <a href="article_edit.aspx?action=<%#PLEnums.ActionEnum.Copy %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>">复制</a>
                            <a href="article_edit.aspx?action=<%#PLEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>">修改</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
                ...
                <ItemTemplate>
                    <li>
                        <div class="details<%#Eval("img_url").ToString() != "" ? "" : " nopic"%>">
                            ...
                            <h1><span><a href="article_edit.aspx?action=<%#PLEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></span></h1>
                            <div class="remark">
                            ...
                            <div class="foot">
                                ...
                                <a href="article_edit.aspx?action=<%#PLEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>" title="编辑" class="edit">编辑</a>
                                <a href="article_edit.aspx?action=<%#PLEnums.ActionEnum.Copy %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>" title="复制" class="copy">复制</a>
                            </div>
                        </div>
                    </li>
                </ItemTemplate>
