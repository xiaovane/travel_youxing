<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_audit.aspx.cs" Inherits="Plumsys.Web.admin.users.user_audit" %>
  ...
  <tr>
    ...
    <td>
      <div class="user-box" style="padding-left:0;">
        <h4><b><a href="user_edit.aspx?action=<%#PLEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("user_name")%></a></b> (昵称：<%#Eval("nick_name")%>)</h4>
