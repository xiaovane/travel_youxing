<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="oauth_app_list.aspx.cs" Inherits="Plumsys.Web.admin.users.oauth_app_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="oauth_app_edit.aspx?action=<%=PLEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td><a href="oauth_app_edit.aspx?action=<%#PLEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
    ...
    <td align="center"><a href="oauth_app_edit.aspx?action=<%#PLEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
