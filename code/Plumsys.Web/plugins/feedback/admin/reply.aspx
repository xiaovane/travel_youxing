<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reply.aspx.cs" Inherits="Plumsys.Web.Plugin.Feedback.admin.reply" ValidateRequest="false" %>
...
<div class="tab-content">
  <dl>
    <dt>所属站点</dt>
    <dd><%=new Plumsys.BLL.channel_site().GetTitle(model.site_path)%></dd>
  </dl>
  <dl>
    <dt>联系人</dt>
