...
using Plumsys.API.Payment.tenpaypc;
using Plumsys.Common;

namespace Plumsys.Web.api.payment.tenpaypc
{
    public partial class index : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //=============================获得订单信息================================
            string order_no = PLRequest.GetFormString("pay_order_no").ToUpper(); //订单号
            decimal order_amount = PLRequest.GetFormDecimal("pay_order_amount", 0); //订单金额
            string user_name = PLRequest.GetFormString("pay_user_name"); //支付用户名
            string subject = PLRequest.GetFormString("pay_subject"); //备注说明
