...
using Plumsys.API.Payment.alipaypc;

namespace Plumsys.Web.api.payment.alipaypc
{
    public partial class index : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            decimal order_amount = PLRequest.GetFormDecimal("pay_order_amount", 0);
            string user_name = PLRequest.GetFormString("pay_user_name");
            ...
            if (Config.Type == "1") //即时到帐
            {
                ...
                sParaTemp.Add("exter_invoke_ip", PLRequest.GetIP()); ////获取客户端的IP地址
